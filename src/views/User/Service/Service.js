            ...
            <div className="service">
                        ...
                        <div className="carousel-inner ">
                            <div className="carousel-item active" data-bs-interval="10000">
                                <div className='d-flex justify-content-center'>
                                    <img src='https://cdn.tgdd.vn/Files/2020/06/08/1261696/moi-tai-bo-hinh-nen-asus-rog-2020-moi-nhat_800x450.jpg' height='75%' class="d-block w-75" alt="..." />
                                </div>
                            ...
                            <div className="carousel-item  " data-bs-interval="2000">
                                <div className='d-flex justify-content-center'>
                                    <img src='https://vietnamitx.com/attachments/top-hinh-nen-dong-wallpaper-engine-desktop-tuyet-dep-download-chon-loc-2021-jpg.2215/' height='75%' class="d-block w-75" alt="..." />
                                </div>
                                <div className="carousel-caption d-none d-md-block">
                            ...
                            <div className="carousel-item">
                                <div className='d-flex justify-content-center'>
                                    <img src='https://1.bigdata-vn.com/wp-content/uploads/2021/12/1639350718_181_Kham-Pha-Bo-Hinh-Nen-Anime-Cuc-Dep-Va-Cuc.jpg' height='75%' class="d-block w-75" alt="..." />
                                </div>
                                <div className="carousel-caption d-none d-md-block">
                ...
                <div>
                    ...
                    <div class="container  p-5">
                        ...
                        <div class="row service-odd p-5 featurette">
                            <div class="col-md-7">
                        ...
                        <div class="row service-even p-5 featurette">
