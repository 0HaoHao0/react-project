										...
										<div className="card-body">
											<div className="row">
												...
												<div className="col-sm-9">
													<input
														type="password"
														className={`text-muted mb-0 class-input form-control profile-input ${isTouched.oldPassword &&
											...
											<div className="row mt-1">
												...
												<div className="col-sm-9">
													<input
														type="password"
														className={`text-muted mb-0 class-input form-control profile-input ${isTouched.newPassword &&
											...
											<div className="row mt-1">
												...
												<div className="col-sm-9">
													<input
														...
														className={`text-muted mb-0 class-input form-control profile-input ${isTouched.confirmPassword &&
										...
										<div className="card-body">
											{
												medicalRecord && (
													<div className="">
														<div className="row">
															<span className="col-6 text-end">Uploaded At: </span>
															<i className="col-6">{new Date(medicalRecord.lastTimeModified).toLocaleString()}</i>
														</div>
														<div className="row">
															<span className="col-6 text-end">File: </span>
															<span className="col-6">
																{
																	medicalRecord.fileURL && (
																		<Link to={medicalRecord.fileURL} className="btn btn-primary" target="_blank">
																			View Details
																		</Link>
																	)																	
																}
																<button onClick={handleUpdateMedicalRecord} className="btn btn-success mx-2">Upload</button>
															</span>
														</div>
