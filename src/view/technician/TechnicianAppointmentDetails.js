            ...
            <div className="technician">
                ...
                <hr />
                    ...
                    <div className="text-start">
                        <button className="btn btn-danger" onClick={() => window.history.back()}>Back</button>
                    </div>
                    {appointment && (
                        <>
                                            ...
                                            <div className="">
                                                {
                                                    states.map((item, idx) => (item.text !== appointment.state) ?
                                                        <button 
                                                            key={idx}
                                                            className={`btn btn${(selectedState?.value !== item.value ? "-outline" : "")}-${item.color} me-2`}
                                                            onClick={(e) => {
                                                                setSelectedState({
                                                                    ...item
                                                                });
                            ...
                            <ImageSegmentationResults appointmentId={id} showLoading={!refreshResults}/>
                        </>                        
                    )}
                    </div>
